  ...
  useEffect(() => {
    ...
    const fetch_hunts = async () => {
      ...
      hunt_data.hunts.forEach((hunt_) => {
        ...
        const fetch_checkpoints = async (id) => {
          const res = await fetch(`/api/get_checkpoints?id=${id}`, {
            method: "GET",
            headers: {
              "Content-Type": "application/json",
            },
          ...
          checkpoint_data.checkpoints.forEach((checkpoint) => {
            let newCheckpoint = {
            ...
            h.checkpoints = [... h.checkpoints, newCheckpoint];
          });
        };

        fetch_checkpoints(hunt_.id);
